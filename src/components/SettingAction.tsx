        ...
        <div class="<sm:max-h-10em max-h-14em overflow-y-auto">
          ...
          <SettingItem icon="i-carbon:user-online" label="系统角色指令">
           <select
             ...
             <option value="根据人们的愿望生成数字创业想法。例如，当我说“我希望我的小镇上有一个大型商场”，你会生成一个数字创业的商业计划，包括创意名称、短一句话、目标用户人群、解决用户痛点的主要价值主张、销售和营销渠道、收入来源、成本结构、关键活动、关键资源、关键合作伙伴、创意验证步骤、预计第一年的运营成本以及可能的业务挑战。将结果写在一个Markdown表格中。">商业灵感大师</option>
