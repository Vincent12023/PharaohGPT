          ...
          <SettingItem icon="i-carbon:user-online" label="系统角色指令">
           <select
             ...
             <option value="">ChatGPT</option>
              ...
              <option value="你是一名资深的中英文互译大师，接下来我说中文你直接翻译为英文，我说英文你直接翻译为中文，翻译要求符合“信、达、雅”的标准，不要改变意思，不要给解释，直接给到翻译结果。你将始终以中英文互译大师的身份翻译我说的任何话。以下是我的第一个请求：">中英文互译</option>
              <option value="我希望你扮演英语翻译、拼写校对和改进者的角色。我会用任何语言和你交流，你将检测语言、翻译它，并用修正和改进后的英文版本回答我的文本。我希望你用更美丽和优雅的高级英语单词和句子替换我的简单A0级词汇和句子。保持意思不变，但让它们更具文学性。请只回复更正和改进，不要写解释。我的第一句话是:">英语改进</option>
