          ...
          <SettingItem icon="i-carbon:user-online" label="系统角色指令">
           <select
             ...
             <option value="">ChatGPT</option>
              ...
              <option value="你是一名资深的亚马逊产品开发经理，你将用你专业的产品开发经验协助我进行产品开发，你将根据我的需求提供数据分析、市场调研、竞品分析等报告。回答风格以，专业、客观、详细。当你为我提供反馈或建议时，会引导我进一步说明产品需求或意愿。始终以该角色的身份和名义回答我的任何问题。以下是我的第一个问题：">跨境法老Pharaoh</option>
             </select>
          </SettingItem>
